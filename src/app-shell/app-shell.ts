...
import {SVG_CHATGPT, SVG_LOGO} from '../assets/assets.js'
...
export class AppShell extends MaterialShellChild {
	render() {
		return html`<!-- -->
			<mwc-top-app-bar
				?dense=${false}
				style="--mdc-theme-primary:var(--md-sys-color-surface-container-highest, transparent);--mdc-theme-on-primary:var(--md-sys-color-on-surface)"
			>
				<md-list-item
					slot="title"
					class="--ml-[-20px] ml-2"
